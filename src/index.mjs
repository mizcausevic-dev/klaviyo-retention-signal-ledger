...
const PRODUCT = {
  "repo": "klaviyo-retention-signal-ledger",
  "vendor": "Klaviyo",
  "title": "retention signal ledger",
  "domain": "Revenue Operations",
  "audience": "Lifecycle marketers, e-commerce operators, RevOps, and product marketing leaders",
  "problem": "Retention programs lose credibility when consent, deliverability, flow performance, revenue attribution, and customer recovery are fragmented.",
  "workflow": "The product maps lifecycle flows, consent posture, deliverability risk, customer recovery, and campaign value into one ledger.",
  "business": "Leaders can identify revenue leakage, protect customer trust, and prioritize lifecycle investments with evidence.",
  "technical": "Synthetic lifecycle lanes are scored deterministically and published as a static retention evidence surface.",
  "integration": "Klaviyo flows, segments, consent records, deliverability metrics, conversion events, and recovery campaigns.",
  "keywords": [
    "Klaviyo",
    "retention marketing",
    "lifecycle ops",
